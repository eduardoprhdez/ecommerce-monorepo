...
export const PRODUCT_EVENT_EMITTER = 'product-event-emitter';
export const SAGA_KAFKA_CONSUMER = 'kafka-saga-consumer';
export const SAGA_MESSAGE_CONSUMER = 'saga-message-consumer';
